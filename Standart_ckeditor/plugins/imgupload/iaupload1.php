...
$upload_dir = array(
 'img'=> '/root/PS/ckeditor/test_images/',
 'audio'=> 'root/PS/ckeditor/test_images/'
);
...
$imgset = array(
 ...
 'type' => array('bmp', 'gif', 'jpg', 'jpe', 'png', 'txt'),  // allowed extensions
);
...
$dataz = array( 'uploaded'=> 1, 'fileName' => $f_name, 'url' => $url);
